    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                application.LoadApplicationConfiguration("E:/Project/net-standard-opcua-server-information-model/BatchPlant/BatchPlant/BatchPlantServer.Config.xml", false).Wait();
